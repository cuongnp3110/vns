...
if(isset($_POST['invoiceCreate'])){
    ...
    if($validate == true){
        mysqli_query($conn, "
        INSERT INTO invoice_im(supplier_id, discount, subtotal, total, payment, note, account_id) 
        VALUES ('".$_POST['sup']."', '".$_POST['discount']."', '".$_POST['subtotal']."', '".$_POST['total']."', '".$_POST['paid']."', '".$_POST['note']."', '".$_SESSION['account_id']."')");
...
<div class="container-fluid" id="container-wrapper" style="display: flex; justify-content: center;">
    <div class="col-lg-12">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold" style="color: #fc544b"><i class="fas fa-fw fa-file-invoice"></i> Create Invoice for Import Products</h6>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2" style="padding-bottom: 0" >
                                <div class="form-group" style="position: absolute; bottom: 0; right: 10px">
                                    <input  style="background-color: #fc544b; border-color: #fc544b" data-loading-text="Saving Invoice..." type="submit" name="invoiceCreate" value="Save Invoice" class="btn btn-success submit_btn invoice-save-btm">						
                                </div>
                            </div>
                        </div>
                    </div>
